...
<div id="div-right">
    <article>
        ...
        ?>
        <h2 style="margin-top: 10px">Galeria-wyszukiwarka</h2>
        <ul id="galleryMenu">
            <li><a href="galeria">Miniatury</a></li>
            <li><a href="galeria-upload">Prześlij zdjęcie</a></li>
            <li style="padding: 10px;border-bottom:  1px solid royalblue">Wyszukiwarka</li>
            <li><a href="galeria-wybrane">Wybrane zdjęcia</a></li>
        </ul>
        <br>
        <br>
        <label for="tt">Wprowadź tytuł: </label>
        <input type="text" name="titlev" id="tt" onkeyup="imgFind()">
