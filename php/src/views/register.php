    ...
    <article>
        ...
        <section>
            ...
            <fieldset>
                ...
                <form action="galeria-rejestracja" style="" method="post">
                    ...
                    <br>
                    <label for="pd">Hasło (min 5 znaków):</label>
                    <br>
                    <input type="password" name="pass" id="pd" required>
                    <br>
                    <label for="pdsr">Potwierdź Hasło:</label>
                    <br>
                    <input type="password" name="passr" id="pdsr" required>
                    <br>
